...
def get_player_name_third_round(soup):
...
while l < len(tournamentList):
    ...
    # Création du fichier
    mon_fichier = open("Chelem_1996_2013", "a")
    ...
    for tournamentYear_url in tournamentYear_urls:
        ...
        third_round_winner = get_player_name_third_round(soup)
        score, winner = get_third_round_winner(soup)
        ...
        while i < len(get_third_round_winner(soup)[0]):
            ...
            nation1 = get_player_specific_nation(soup2, player1, soup3)
            nation2 = get_player_specific_nation(soup2, player2, soup3)
            #winner, score = get_fourth_round_winner32(soup)
            prize = get_tournament_prizemoney(soup)
            rank1 = get_player_specific_rank(soup2, player1, soup3)
            rank2 = get_player_specific_rank(soup2, player2, soup3)
