...
tournamentList = ['540']#, '520', '580', '560']
...
def get_player_name_seventh_round(soup):
...
while l < len(tournamentList):
    ...
    for tournamentYear_url in tournamentYear_urls:
        ...
        seventh_round_winner = get_player_name_seventh_round(soup)
        ...
        while i < 1:
            player1 = seventh_round_winner[j] #
            player2 = seventh_round_winner[j+1]
