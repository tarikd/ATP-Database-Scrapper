...
tournamentList = ['560'] #, '580', '520', '540']
...
def get_player_name_sixth_round(soup):
...
while l < len(tournamentList):
    ...
    for tournamentYear_url in tournamentYear_urls:
        ...
        sixth_round_winner = get_player_name_sixth_round(soup)
        score, winner = get_sixth_round_winner(soup)
