...
def get_first_round_winner32(soup):
    ...
    return list_name_winner_first_round
...
def get_second_round_winner32(soup):
    colonne3 = soup.find("td", "col_3")
...
while l < len(tournamentList):
    ...
    while r32 < len(tournamentYear_urls32):
        ...
        for tournamentYear_url in tournamentYear_urls32:
            ...
            first_round_winner = get_first_round_winner32(soup)
            size = get_second_round_winner32(soup)[0]
            winner, score = get_second_round_winner32(soup)
