...
#tournamentList = ['403', '410', '1536', '416', '421', '422', '5014', '352', '404']
...
def get_player_name_fifth_round_winner128(soup):
    colonne6 = soup.find("td", "col_7")
...
def get_final_round_winner128(soup):
    colonne7 = soup.find("td", "col_8")
...
while l < len(tournamentList):
    ...
    mon_fichier = open("Masters1000_1996_2013", "a")
    ...
    for tournamentYear_url in tournamentYear_urls_clean:
        ...
        if get_tournament_date(soup) != 2:
            ...
            if get_tournament_draw(soup) <= 64:
                ...
                fourth_round_winner = get_player_name_fifth_round_winner128(soup)
                size = get_final_round_winner128(soup)
                winner, score = get_final_round_winner128(soup)
