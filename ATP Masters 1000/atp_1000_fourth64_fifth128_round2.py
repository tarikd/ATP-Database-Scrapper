...
def get_player_name_second_round_winner64(soup):
...
def get_player_name_third_round_winner128(soup):
    colonne4 = soup.find("td", "col_5")
...
def get_third_round_winner64(soup):
    colonne4 = soup.find("td", "col_5")
...
def get_fourth_round_winner128(soup):
    colonne5 = soup.find("td", "col_6")
...
while l < len(tournamentList):
    ...
    while r32 < len(tournamentYear_urls32):
        mon_fichier = open("Masters1000_1996_2013_2", "a")
        ...
        for tournamentYear_url in tournamentYear_urls32:
            ...
            second_round_winner = get_player_name_second_round_winner64(soup)
            size = get_third_round_winner64(soup)[0]
            winner, score = get_third_round_winner64(soup)
    ...
    while r64 < len(tournamentYear_urls64):
        ...
        for tournamentYear_url in tournamentYear_urls64:
            ...
            third_round_winner = get_player_name_third_round_winner128(soup)
            size = get_fourth_round_winner128(soup)[0]
            winner, score = get_fourth_round_winner128(soup)
            draw = get_tournament_draw(soup)
            round_name = "Fifth Round"
            file_name = "_Fifth_Round128"
