...
def get_player_name_second_round_winner128(soup):
...
def get_third_round_winner128(soup):
...
while l < len(tournamentList):
    ...
    while r32 < len(tournamentYear_urls32):
        mon_fichier = open("Masters1000_1996_2013_3", "a")
        ...
        for tournamentYear_url in tournamentYear_urls32:
            ...
            first_round_winner = get_first_round_winner64(soup)
    ...
    while r64 < len(tournamentYear_urls64):
        ...
        for tournamentYear_url in tournamentYear_urls64:
            ...
            second_round_winner = get_player_name_second_round_winner128(soup)
            size = get_third_round_winner128(soup)[0]
            winner, score = get_third_round_winner128(soup)
            draw = get_tournament_draw(soup)
            round_name = "Fourth Round"
            file_name = "_Fourth_Round128"
