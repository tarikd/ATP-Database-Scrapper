...
def get_player_name_fourth_round_winner128(soup):
...
def get_fifth_round_winner128(soup):
    colonne6 = soup.find("td", "col_7")
...
while l < len(tournamentList):
    ...
    while r32 < len(tournamentYear_urls32):
        mon_fichier = open("Masters1000_1996_2013_1", "a")
    ...
    while r64 < len(tournamentYear_urls64):
        ...
        for tournamentYear_url in tournamentYear_urls64:
            ...
            fourth_round_winner = get_player_name_fourth_round_winner128(soup)
            size = get_fifth_round_winner128(soup)
            winner, score = get_fifth_round_winner128(soup)
            draw = get_tournament_draw(soup)
            round_name = "Sixth Round"
            file_name = "_Sixth_Round128"
